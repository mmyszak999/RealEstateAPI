...
from tests.test_users.conftest import db_user, db_staff_user, db_superuser
...
async def db_leases(
    ...
    staff_property = [
        property for property in available_properties.results if property.owner_id == db_staff_user.id
    ]
    ...
    return await get_all_leases(async_session, PageParams(), output_schema=LeaseOutputSchema)
